...
export const Signup = () => {
  ...
  return (
          ...
          <form className='max-w-md basis-11/12 dark:bg-gray-600 p-5 rounded-xl' onSubmit={handleSignup}>
                  <div>
        <p className='text-gray-900 dark:text-white mb-6 text-sm'> A registred user? <Link to='/login' className='hover:cursor-pointer hover:underline  text-blue-600 dark:text-blue-500'> Login</Link></p>
    </div>  
  <div className="mb-6">
